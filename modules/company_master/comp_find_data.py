...
def comp_find_scr():
    ...
    ttkb.Label(main_frame, text="Email", font=('Segoe UI', 11)).grid(row=5, column=0, sticky=W, pady=8, padx=(0, 15))
    m = ttkb.Entry(main_frame, width=30, bootstyle="info")
    m.grid(row=5, column=1, pady=8)

    ttkb.Label(main_frame, text="Phone No", font=('Segoe UI', 11)).grid(row=6, column=0, sticky=W, pady=8, padx=(0, 15))
    ...
    ttkb.Button(main_frame, text="Close", bootstyle="danger", width=12, command=cm).grid(row=8, column=0, columnspan=2, pady=(25, 0))
