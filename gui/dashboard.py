...
h1=Button(t,text='TAP TO INSERT',bg='tomato',command=tax_ins_scr)
h1.place(x=1205,y=150)
h2=Button(t,text='TAP TO UPDATE',bg='red2',command=tax_upd_scr)
h2.place(x=1200,y=200)
h3=Button(t,text='TAP TO DELETE',bg='tomato',command=tax_del_scr)
h3.place(x=1200,y=250)
h4=Button(t,text='TAP TO FIND',bg='red2',command=tax_find_scr)
h4.place(x=1205,y=300)
h5=Button(t,text='TAP TO VIEW DATA',bg='tomato',command=tax_data_scr)
h5.place(x=1200,y=350)
h6=Button(t,text='TAP TO SHOW ALL DATA',bg='red2',command=tax_show_scr)
h6.place(x=1185,y=400)
